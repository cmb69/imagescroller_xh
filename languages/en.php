...
$plugin_tx['imagescroller']['syscheck_phpversion']="PHP version ≥ %s";
...
$plugin_tx['imagescroller']['cf_controls_dynamic']="Whether display the controls shall be displayed only while hovering over the image. If disabled, the play/pause control is not available.";
$plugin_tx['imagescroller']['cf_autoload']="Whether the necessary JavaScript shall be autoloaded. Enable, if used from the template.";
